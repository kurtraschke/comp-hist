...
SRCS = $(CTSS-SRCS) $(CPM-SRCS) $(ORD-SRCS) $(PARC-SRCS) $(APPLE-SRCS) $(INTEL-SRCS) $(IBM-SRCS) $(SINCLAIR-SRCS) $(DEC-SRCS) $(LINC-SRCS) $(DATAGEN-SRCS) $(TRANSISTOR-SRCS) $(MOTOROLA-SRCS) $(NEXT-SRCS) $(LISP-SRCS) $(SH-SRCS) $(BE-SRCS) $(ALGOL-SRCS) $(CRAY-SRCS) $(CORP-SRCS) $(WAITS-SRCS) $(FORTRAN-SRCS)
